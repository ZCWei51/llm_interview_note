...
> <font color='green'>注意：Seq2Seq模型和Attention机制的区别。</font>
...
> <font color='red'>不是很理解这里target-attention。</font>
...
> <font color='red'>这两者的理解还不到位，以至于不知道为何会有这样的问题出现。</font>
...
> <font color='red'>其他地方有说到不同层之间是不共享权重的，注意力层和前反馈层之间也不共享！</font>
...
> <font color=red>除了第一个其他的都没见过。</font>
...
> <font color=red>这个原理没看懂，先放着，知道目的就行</font>
...
**关注点**：怎么有效的去使用序列的信息。
> <font color=green>区别在于如何去拿序列中的信息，RNN 是通过上一个时刻的输出（上一个时刻的信息包含了前文传播下来的的所有信息），Transformer 是通过全局的序列信息。</font></font>
